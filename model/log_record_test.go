...
func TestDecodeLogRecordHeader(t *testing.T) {
	...
	assert.Equal(t, constant.LogRecordNormal, h1.recordType)
	...
	assert.Equal(t, constant.LogRecordNormal, h2.recordType)
	...
	assert.Equal(t, constant.LogRecordDelete, h3.recordType)
